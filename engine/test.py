    ...
    def google(name):
        try:
            ...
            try:
                ...
                speak("No internet connection in the moment....!!")
                speak("Looking in history to find results..!!!")
            try:
                try:
            ...
            try:
                ...
                for i in range(0,length):
                    if query.lower() in data["Query"][i].lower() :
                        #print(data["Answer"][i])
                        ans = data["Answer"][i]
                        return ans
            except:
                #speak("You never serach for it there is no record found..! Try to connect to the internet and try again..")
                ans = "You never serach for it there is no record found..! Try to connect to the internet and try again.."
                return ans
    def result():
        nonlocal query,ans
        speak("Searching!")
        query=textF.get()
        if query == "Enter your query":
            content = "Hello  i am  karl . i am created by Abhayparashar31 . i am here to make your google query search easy and simple. try to type something onto text boxt and search ....."
            #speak("Hello  i am  karl . i am created by Abhayparashar31 . i am here to make your google query search easy and simple. try to type something onto text boxt and search .....")
